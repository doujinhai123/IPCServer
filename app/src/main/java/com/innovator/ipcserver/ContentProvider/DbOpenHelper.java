...
public class DbOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "book_provider_.db";
    ...
    private String CREATE_USER_TABLE = "CREATE TABLE IF NOT EXISTS "+USER_TABLE_NAME+"(_id INTEGER PRIMARY KEY,"
            +"name TEXT,"+"sex INT)";
